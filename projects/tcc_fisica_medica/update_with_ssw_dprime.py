...
# Full master monograph LaTeX content with SSW-d' fully elaborated
full_monograph_tex = r"""\documentclass[
  12pt,
  a4paper,
  oneside
]{report}
...
raw_cites = re.findall(r'\\cite\{([^}]+)\}', full_monograph_tex)
ordered_keys = []
for c in raw_cites:
...
# Comprehensive bibliographic database (strictly numeric, ABNT standard)
bib_database = {
    ...
    "icru54_1996": r"INTERNATIONAL COMMISSION ON RADIATION UNITS AND MEASUREMENTS (ICRU). \textbf{Medical Imaging - The Assessment of Image Quality}. ICRU Report 54. Bethesda, MD: ICRU, 1996. 88 p.",
    ...
    "lusted1968": r"LUSTED, L. B. \textbf{Introduction to Medical Decision Making}. Springfield, IL: Charles C. Thomas, 1968. 271 p.",
    "metz1986": r"METZ, C. E. ROC methodology in radiologic imaging. \textbf{Investigative Radiology}, v. 21, n. 9, p. 720--733, 1986.",
    "barrett_myers_2004": r"BARRETT, H. H.; MYERS, K. J. \textbf{Foundations of Image Science}. Hoboken, NJ: John Wiley \& Sons, 2004. 1584 p.",
    "wagner1979": r"WAGNER, R. F.; BROWN, D. G.; METZ, C. E. Unified analysis of medical imaging systems. \textbf{Medical Physics}, v. 6, n. 2, p. 83--94, 1979.",
    "burgess1994": r"BURGESS, A. E. Statistically defined backgrounds in medical imaging. \textbf{Journal of the Optical Society of America A}, v. 11, n. 4, p. 1237--1242, 1994.",
    "eckstein2000": r"ECKSTEIN, M. P. et al. Model observers for visual search tasks in medical imaging. \textbf{Physics in Medicine \& Biology}, v. 45, n. 8, p. 2375--2388, 2000.",
    "myers_barrett_1987": r"MYERS, K. J.; BARRETT, H. H. Addition of a channel mechanism to the ideal-observer model. \textbf{Journal of the Optical Society of America A}, v. 4, n. 12, p. 2447--2457, 1987.",
    "gallas2003": r"GALLAS, B. D.; BARRETT, H. H. Validating the use of channels to estimate the ideal linear observer. \textbf{Journal of the Optical Society of America A}, v. 20, n. 9, p. 1725--1738, 2003.",
    "aapm_report204": r"AMERICAN ASSOCIATION OF PHYSICISTS IN MEDICINE (AAPM). \textbf{Size-Specific Dose Estimates (SSDE) in Pediatric and Adult Body CT Examinations}. AAPM Report No. 204. College Park, MD: AAPM, 2011. 68 p.",
    "fitton2026": r"FITTON, I.; GREFFIER, J.; DABLI, D.; VAN NGOC TY, C. Size-specific weighted detectability index for computed tomography image characterization. \textbf{Medical Physics}, v. 53, n. 9, p. e17420, 2026.",
    "goppel2021": r"GOPPEL, M. et al. Task-based image quality assessment in CT: Size-specific optimization of radiation dose and lesion contrast. \textbf{European Radiology}, v. 31, p. 5812--5822, 2021.",
    "dorfman1992": r"DORFMAN, D. D.; BERBAUM, K. S.; METZ, C. E. Receiver operating characteristic rating analysis: generalization to the population of readers and cases with the jackknife method. \textbf{Investigative Radiology}, v. 27, n. 9, p. 723--731, 1992.",
    ...
    "dosovitskiy2020": r"DOSOVITSKIY, A. et al. An image is worth 16x16 words: Transformers for image recognition at scale. In: \textbf{International Conference on Learning Representations (ICLR)}, 2021. p. 1--21.",
    ...
    "willemink2018": r"WILLEMINK, M. J. et al. Photon-counting CT: technical principles and clinical prospects. \textbf{Radiology}, v. 289, n. 2, p. 293--312, 2018.",
    "rajendran2021": r"RAJENDRAN, K. et al. First clinical photon-counting detector CT system: technical evaluation. \textbf{Radiology}, v. 303, n. 1, p. 130--138, 2021.",
    ...
    "deb2002": r"DEB, K. et al. A fast and elitist multiobjective genetic algorithm: NSGA-II. \textbf{IEEE Transactions on Evolutionary Computation}, v. 6, n. 2, p. 182--197, 2002.",
    "hwang1981": r"HWANG, C. L.; YOON, K. \textbf{Multiple Attribute Decision Making: Methods and Applications}. Berlin: Springer-Verlag, 1981. 259 p.",
...
final_tex_content = full_monograph_tex + bib_block

# Write to Overleaf_TCC_Wagner_SingleFile/main.tex
with open(main_tex_path, "w", encoding="utf-8") as f:
    f.write(final_tex_content)

# Update reorganize_logical_flow.py with this new content so future runs preserve everything
with open("/Users/user/.gemini/antigravity-ide/scratch/reorganize_logical_flow.py", "w", encoding="utf-8") as f:
...
print("Monografia atualizada com sucesso com a incorporação do SSW-d'!")
print(f"Total de caracteres gerados: {len(final_tex_content)}")
print(f"Total de linhas geradas: {len(final_tex_content.splitlines())}")
